...
def insert_to_db(file_name,table):
	...
	for line in data_file:
		...
		share_info = get_share_value(data[1],data[0])
		if share_info == None:
			continue
		statement = create_statement(statement1,statement2,share_info)
		print(statement)
...
def create_statement(statement1,statement2,days_data):
	if len(days_data) == 5:
		...
		days = ",\'{day1}\',\'{day2}\',\'{day3}\',\'{day4}\');".format(day1=days_data[0],day2=days_data[1],day3=days_data[2],day4=days_data[3])
